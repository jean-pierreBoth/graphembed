...
if __name__ == "__main__":
    bson_file = "embedding_output.bson"          # <-- your file
    out_vectors, in_vectors = load_embedding_bson(bson_file, want_in=True)

    print("OUT embedding shape :", out_vectors.shape)
    print("first OUT vector    :", out_vectors[0])

    if in_vectors is not None:
        print("IN  embedding shape :", in_vectors.shape)
        print("first IN  vector    :", in_vectors[0])
